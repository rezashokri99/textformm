...
const IntroductoryTexts = () => {
    return (
        <div className="w-11/12 lg:w-[1000px] font-iranyekan">
            <div className="w-full my-[50px] font-iranyekan">
            ...
            <div>
                <h1 className="mb-[50px] text-[26.5px] text-center font-bold text-white font-iranyekan">توی طرح معدل ساز صفر کلوین چیکار می‌کنیم؟</h1>


                <div className="flex flex-col sm:flex-row sm:items-center sm:mb-4 font-iranyekan">
                ...
                <div className="flex flex-col sm:flex-row-reverse sm:items-start sm:mb-4 font-iranyekan">
                ...
                <div className="mb-[100px] flex flex-col sm:justify-center sm:items-center mt-3 font-iranyekan">
                    ...
                    <div className="sm:w-[500px] font-iranyekan">
                ...
                <div className="mx-[15px] mb-[15px] flex items-center justify-center font-iranyekan">
