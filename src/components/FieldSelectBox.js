...
export default function FieldSelectBox({ field_name, setField_name, setField_id, fields }) {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left w-full font-sans">
            ...
            <Menu.Items className="font-sans z-10 w-full origin-top-right absolute right-0 mt-2 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none">
                {
                    fields.map((field) => (
